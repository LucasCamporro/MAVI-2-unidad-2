...
void Game::InitPhysics()
{
	...
	groundDefinicion.position.Set(0.0f, 95.0f); // Posición del cuerpo
	groundBody = phyWorld->CreateBody(&groundDefinicion); // Creamos el cuerpo dinámico
	// Creamos una forma (rectangular en este caso) para el cuerpo
	b2PolygonShape groundShape;
	groundShape.SetAsBox(95.0f, 0.0f); // Tamaño del cubo
	...
	fixturegroundDef.friction = 0.50f; // Fricción
	fixturegroundDef.restitution = 0.0f; // Restitución (rebote)
	...
	cuboDefinicion.position.Set(50.0f, 90.0f); // Posición del cuerpo
